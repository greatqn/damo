...
import com.damo.shiro.autoconfigure.stateless.support.jwt.DefaultPayloadTemplate;
...
import com.damo.shiro.autoconfigure.stateless.support.jwt.PayloadTemplate;
import com.damo.shiro.autoconfigure.stateless.support.jwt.exception.NotExistPayloadTemplateException;
...
public class JWTManagerTest {
    ...
    JWTManager manager = new JWTManager(new DefaultJWTAlgorithmProvider(new ShiroWebProperties())) ;
