 ...
 *
 */
public class VerifiableSerialService {
    ...
    public static void main(String[] args) throws Exception{
        ...
        code = create(0,9);
        System.out.println("code: " + code);
        System.out.println("verify: " + verify(code, getActId(code) > 0));
        System.out.println("actId: " + getActId(code));

        System.out.println(verify("WSMHDCWH6WYQ", actId > 0));
        System.out.println(verify("6AXQXFC", actId > 0));
        System.out.println(verify("6AXQXFC", false));
        System.out.println(verify("ZKTPY6TJE", true));
    }
}
